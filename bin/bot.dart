        ...
        while (flag) {
          ...
          switch (input) {
            ...
            case "add_channel":
              ...
              break;
            // case "send_c_message":
            //   await chan_msg.channel_message(db2, db3, db4, server_store,
            //       channel_store, message_store, c_user_c);
            //   break;
            // case "open_c_message":
            //   await chan_msg.show_channel_message(db2, db3, db4, server_store,
            //       channel_store, message_store, c_user_c);
            //   await chan_msg.channel_message(db2, db3, db4, server_store,
            //       channel_store, message_store, c_user_c);
            //   break;
            ...
            case "open_chats":
              ...
              break;
            case "send_chat":
              await c_msg.personal_dm(
                  db5, db1, p_dm_store, user_store, c_user_c);
              break;
            // case "help":
